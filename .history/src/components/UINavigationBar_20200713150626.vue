 ...
 <div>
   <div> 
     ...
     <el-menu-item index="1" @click="homepage">
      ...
      <el-menu-item index="4" @click="article">
        <i class="el-icon-check"></i>
        <span slot="title">发表文章</span>
      </el-menu-item>
       <el-menu-item index="5" @click="tab">
        <i class="el-icon-paperclip"></i>
        <span slot="title">标签页</span>
      </el-menu-item>
       <el-menu-item index="6" @click="exportr">
        <i class="el-icon-caret-top"></i>
        <span slot="title">导出Excel</span>
      </el-menu-item>
      <el-menu-item index="7" @click="statistics">
        <i class="el-icon-menu"></i>
        <span slot="title">分页表格</span>
      </el-menu-item>
       <el-menu-item index="8" @click="picturepupload">
        <i class="el-icon-sell"></i>
        <span slot="title">图片上传</span>
      </el-menu-item>
       <el-menu-item index="9" @click="signout">
...
<script>
 export default {
   ...
   methods: {
       ...
       picturepupload(){
           this.$router.push('/picturepupload')
       },
       signout(){
