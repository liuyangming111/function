<template>
  <div>
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane :label="unreads" name="first">
      ...
      <el-tab-pane :label="deletesss" name="second">
      ...
      <el-tab-pane :label="reductionss" name="third">
...
export default {
  ...
  methods: {
    ...
    read(){
      this.brr=this.brr.concat(this.arr);
      this.arr=[];
    },
    deletess(){
      this.crr=this.crr.concat(this.brr);
      this.brr=[];
    },
    reductions(){
      this.crr=[]
  ...
  computed: {
    deletesss(){
      return `已读消息 ${this.brr.length}`
    },
    unreads(){
      return `已读消息 ${this.arr.length}`
    },
    deletesss(){
      return `已读消息 ${this.crr.length}`
    }
  }
};
</script>
