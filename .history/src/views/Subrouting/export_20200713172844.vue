<template>
  <div>
    <el-table :data="tableData.slice((currentPage-1)*pageSize, currentPage*pageSize)" style="width: 100%">
      ...
      <el-table-column width="300" align="right"><el-button type="primary" @click="primary">编辑</el-button></el-table-column>
      <el-table-column><el-button type="danger">删除</el-button></el-table-column>
    </el-table>
      <div class="block">
    <el-pagination
