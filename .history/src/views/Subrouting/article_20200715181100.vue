      ...
      <div style="display: flex;">
        ...
        <el-form-item label="重要性" prop="star">
          <el-select v-model="ruleForm.star" placeholder="请选择" style="width:150px">
            <el-option label="1" value="100"></el-option>
            <el-option label="2" value="200"></el-option>
            <el-option label="3" value="300"></el-option>
            <el-option label="4" value="400"></el-option>
            <el-option label="5" value="500"></el-option>
          </el-select>
        </el-form-item>
        <div style="display: flex;">
