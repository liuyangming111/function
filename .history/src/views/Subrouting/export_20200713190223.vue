<template>
  <div>
    <el-table :data="tableData.slice((currentPage-1)*pageSize, currentPage*pageSize)" style="width: 100%">
      ...
      <el-table-column width="270" align="right"><el-button type="primary" @click="primarys">编辑</el-button></el-table-column>
      <el-table-column><template slot-scope="scope"><el-button type="danger" @click.native.prevent="deleteRow(scope.$index, tableData)">删除</el-button></el-table-column>
    </el-table>
      <div class="block">
        <el-pagination
